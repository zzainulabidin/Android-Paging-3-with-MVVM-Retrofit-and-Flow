...
import com.app.githubusers.databinding.NetworkStateItemBinding


class UsersLoadingStateAdapter(private val retry: () -> Unit) :
    LoadStateAdapter<UsersLoadingStateAdapter.LoadStateViewHolder>() {
